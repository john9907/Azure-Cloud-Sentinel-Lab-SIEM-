...
<br />
<br />
In the final step, log analytics was utilized in conjunction with the virtual machine and the PowerShell script to gather all of the failed login attempts. Then, the KQL script from the previous step was used with Azure Sentinel map workbook to plot the geographic data on a world map.
<br />
<br />
